...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CampArea.description'
        db.alter_column(u'camps_app_camparea', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'CampArea.description'
        db.alter_column(u'camps_app_camparea', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))
