...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CampMeritBadge'
        db.create_table(u'camps_app_campmeritbadge', (
            ...
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meritbadges_app.MeritBadge'])),
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['camps_app.CampArea'])),
        ))
        db.send_create_signal(u'camps_app', ['CampMeritBadge'])


    def backwards(self, orm):
        # Deleting model 'CampMeritBadge'
        db.delete_table(u'camps_app_campmeritbadge')
    ...
    models = {
        ...
        u'camps_app.campmeritbadge': {
            'Meta': {'ordering': "['camp__name', 'badge__name']", 'object_name': 'CampMeritBadge'},
            'area': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['camps_app.CampArea']"}),
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['meritbadges_app.MeritBadge']"}),
            'camp': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['reservations_app.ReservationCamp']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {}),
        ...
        u'meritbadges_app.meritbadge': {
            'Meta': {'ordering': "['name']", 'object_name': 'MeritBadge'},
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
