...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReservationSiteAdministrator'
        db.create_table(u'reservations_app_reservationsiteadministrator', (
        ...
        db.send_create_signal(u'reservations_app', ['ReservationSiteAdministrator'])
    ...
    def backwards(self, orm):
        # Deleting model 'ReservationSiteAdministrator'
        db.delete_table(u'reservations_app_reservationsiteadministrator')
