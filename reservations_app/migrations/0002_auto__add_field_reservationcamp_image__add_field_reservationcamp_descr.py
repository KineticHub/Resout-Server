...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReservationCamp.image'
        db.add_column(u'reservations_app_reservationcamp', 'image',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ReservationCamp.description'
        db.add_column(u'reservations_app_reservationcamp', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReservationCamp.image'
        db.delete_column(u'reservations_app_reservationcamp', 'image')

        # Deleting field 'ReservationCamp.description'
        db.delete_column(u'reservations_app_reservationcamp', 'description')
    ...
    models = {
        ...
        u'reservations_app.reservationsiteadministrator': {
            'Meta': {'object_name': 'ReservationSiteAdministrator'},
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
